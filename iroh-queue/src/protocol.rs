...
/// ALPN protocol identifier for the iroh-queue direct stream protocol.
pub const ALPN: &[u8] = b"iroh-queue/0";

/// Maximum message size (16 MiB) to guard against malicious peers.
...
pub enum GossipSignal {
    ...
    /// A consumer is ready to accept work.
    ConsumerReady {
        consumer: EndpointId,
        capacity: u32,
    },
